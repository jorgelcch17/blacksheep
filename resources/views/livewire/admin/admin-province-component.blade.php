<div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            wire:click.prevent="storeProvince">Guardar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @foreach ($provinces as $province)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $province->name }}
                                                    <!-- Button trigger modal -->
                                                    <a wire:click.prevent="editProvince({{ $province->id }})"
                                                ...
                                                @if ($province->status == 1)
                                                    <td><a href="#"
                                                            wire:click.prevent="changeStatusProvince({{ $province->id }})"><span
                                                ...
                                                @endif
                                                <td class="text-end">
                                                    <a href="{{ route('admin.cities', [$department, $province]) }}">
    ...
    <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Editar Provincia</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 mt-3">
                        <label for="name" class="form-label">Nombre</label>
                        <input type="text" name="name" class="form-control" placeholder="Ingrese el nombre de la provincia"
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" name="slug" class="form-control" placeholder="Ingrese el slug de la provincia"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click.prevent="updateProvince">Guardar</button>
                </div>
            </div>
        </div>
    </div>
