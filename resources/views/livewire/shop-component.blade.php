                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Se ha encontrado <strong class="text-brand">{{ $products->total() }}</strong> productos para ti!</p>
                            </div>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy=='Precio: Bajo a alto' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Precio: Bajo a alto')">Precio: Bajo a alto</a></li>
                                            <li><a class="{{ $orderBy=='Precio: Alto a bajo' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Precio: Alto a bajo')">Precio: Alto a bajo</a></li>
                                            <li><a class="{{ $orderBy=='mas recientes' ? 'active': '' }}" href="#" wire:click.prevenet="changeOrderBy('mas recientes')">más recientes</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details', $product->slug) }}">
                                                    <img class="default-img"
                                                        src="{{ asset('assets/imgs/shop/product-') }}{{ $product->id }}-1.jpg" alt="{{ $product->name }}">
                                                    <img class="hover-img"
                                                        src="{{ asset('assets/imgs/shop/product-') }}{{ $product->id }}-2.jpg" alt="{{ $product->name }}">
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up" wire:click.prevent="store({{ $product->id}}, '{{ $product->name}}', {{ $product->regular_price }})"
