                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="email" placeholder="Tu correo" :value="old('email')" required autofocus>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up" name="login">Ingresar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
